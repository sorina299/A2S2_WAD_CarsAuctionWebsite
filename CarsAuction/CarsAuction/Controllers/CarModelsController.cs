...
namespace CarsAuction.Controllers
{
    public class CarModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,BrandID")] CarModel carModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,BrandID")] CarModel carModel)
        {
            if (id != carModel.ID)
            {
                return NotFound();
